      ...
      <Table.Cell {...props} style={{ padding: 1 }}>
        {!rowData.archived && (
          <Button
            appearance='link'
            loading={
              props.questionArchiving === rowData.questionId
            }
            onClick={() => {
    ...
    <Grid container justify='center'>
      <GridItem xs={12} sm={12} md={10}>
        {adminQuestions && adminQuestions.length > 0 ? (
          <div>
            <Button appearance='primary' onClick={() => props.setInitQuestionAdd(true)}>
              Create Long Form Question
						</Button>

            <Modal show={props.initQuestionAdd} onHide={() => props.setInitQuestionAdd(false)}>
              <Form
                fluid
                ref={ref => (form = ref)}
                model={model}
              ...
              >
                ...
                <Modal.Footer>
                  ...
                  <Button onClick={() => props.setInitQuestionAdd(false)} appearance="subtle">
                    Cancel
                </Button>
                </Modal.Footer>
              </Form>
